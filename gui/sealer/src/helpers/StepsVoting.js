import {RiNumber3, RiNumber4, RiNumber5} from "react-icons/ri"
...
const StepsVoting = () => {
    ...
    return (
        ...
        <div class="block w-1/4 md:flex relative md:pb-12">
            <div className="flex justify-center">
                <div class="h-8 md:h-full w-full md:w-10 absolute inset-0 flex items-center justify-end md:justify-center">
                    <div class="float-right h-1 md:h-full w-1/2 md:w-1 bg-logodblue-300"></div>
                </div>
                <div class="flex-shrink-0 w-8 md:w-10 h-8 md:h-10 rounded-full bg-white inline-flex items-center justify-center text-logodblue-300 relative z-10 border-2 border-logodblue-300">
                    <FaCheck size={20}/>
                </div>
            </div>
        ...
        <div class="block w-1/4 md:flex relative md:pb-12">
            <div className="flex justify-center">
                <div class="h-8 md:h-full w-full md:w-10 absolute inset-0 flex items-center justify-end md:justify-center">
                    <div class="md:hidden h-1 md:h-full w-full md:w-1 bg-logodblue-300"></div>
                    <div class="h-1 md:h-full w-full md:w-1 bg-logodblue-300"></div>
                </div>
                <div class="flex-shrink-0 w-8 md:w-10 h-8 md:h-10 rounded-full bg-white inline-flex items-center justify-center text-logodblue-300 relative z-10 border-2 border-logodblue-300">
                    <FaCheck size={20}/>
                </div>
        ...
        <div class="block w-1/4 md:flex relative md:pb-12">
            <div className="flex justify-center">
                ...
                <div class="flex-shrink-0 w-8 md:w-10 h-8 md:h-10 rounded-full bg-logodblue-300 inline-flex items-center justify-center text-white z-10">
                    <RiNumber3 size={20}/>
                </div>
            </div>
            <div class="hidden md:flex pl-4 items-center">
