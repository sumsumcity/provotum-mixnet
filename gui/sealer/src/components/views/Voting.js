                        ...
                        <div class="flex justify-center ">
                            <div class="w-full sm:w-2/3 flex flex-col">
                                <div class="pt-5 sm:pt-20 text-center">
                                    <svg role="status" class="inline w-16 sm:w-20 h-16 sm:h-20 text-logodblue-300 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className="text-center text-logodblue-300 text-sm lg:text-base mt-3">
                                    {t("statusVoting")}
                                </p>
                            </div>
                        </div>
