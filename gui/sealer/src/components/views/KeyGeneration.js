                        ...
                        <div class="container px-5 py-7 mx-auto">
                            <div class="w-full lg:w-1/2 mx-auto text-center">
                                ...
                                <div class="flex justify-center">
                                    {clickedCreateKey ? 
                                    (
                                    <button disabled type="button" class="w-1/2 sm:w-1/3 text-white bg-logodblue-300 py-2 px-8 enabled:hover:bg-logodblue-500 rounded-lg text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
