                        ...
                        <div class="container px-5 py-7 mx-auto">
                            <div class="w-1/2 mx-auto text-center">
                                ...
                                <div class="flex justify-center">
                                    ...
                                    : 
                                    (
                                    <button onClick={() => createKey()} disabled={vote.sealers.indexOf(window._env_.SEALER) > -1} class="w-1/3 text-white bg-logodblue-300 py-2 px-8 enabled:hover:bg-logodblue-500 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("buttonKeyGen")}</button>
                                    )}
                                </div>
                            </div>
                        </div>
