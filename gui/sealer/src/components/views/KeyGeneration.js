                            ...
                            <div class="w-1/2 mx-auto text-center">
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-center items-center pt-4 pb-7">
                                        ...
                                        <p className=" text-base text-logobrown-1000/50 mx-2">{t("statusKeyGen")}</p>
                                    </div>
                                </div>
                                )}
                                ...
                                <div class="flex justify-center">
                                    ...
                                    : 
                                    (
                                    <button onClick={() => createKey()} disabled={vote.sealers.indexOf(window._env_.SEALER) > -1} class="w-1/3 text-white bg-logolblue-500 py-2 px-8 enabled:hover:bg-logolblue-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("buttonKeyGen")}</button>
                                    )}
                                </div>
                            </div>
                        </div>
