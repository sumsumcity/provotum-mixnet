                            ...
                            <div class="w-1/2 mx-auto text-center">
                                ...
                                <div>
                                    <div className="flex justify-center items-center">
                                        ...
                                        <p className=" text-xl text-logobrown-1000 mx-2">1/1 public keys have been created</p>
                                    </div>
                                    <div className="flex justify-center items-center pt-4 pb-7 ">
                                        <FaCheck class="inline w-4 h-4 mr-3 text-green-700"/>
                                        <p className=" text-base text-logobrown-1000 mx-2">key creation was successfull</p>
                                    </div>
                                    <div className="flex justify-center items-center pt-4 pb-7">
                                        ...
                                        <p className=" text-base text-logobrown-1000/50 mx-2">wait for voting authority to start vote</p>
                                    </div>
                                </div>
                                ) 
                                : 
                                ...
                                <div>
                                    <div className="flex justify-center items-center">
                                        <FaKey className="text-logobrown-1000 mx-2"/>
                                        <p className=" text-xl text-logobrown-1000 mx-2">0/1 public keys have been created</p>
                                    </div>
                                    <div className="flex justify-center items-center pt-4 pb-7">
                                        <svg role="status" class="inline w-4 h-4 mr-3 text-logobrown-1000/50 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="#E5E7EB"/>
                                        ...
                                        <p className=" text-base text-logobrown-1000/50 mx-2">waiting for key creation</p>
                                    </div>
                                </div>
                                )}
                                <span class="inline-block h-1 w-1/2 rounded bg-logolblue-200 mb-6"></span>
                                <div class="flex justify-center">
                                    {clickedCreateKey ? 
                                    (
                                    <button disabled type="button" class="w-1/3 text-white bg-logolblue-500 py-2 px-8 enabled:hover:bg-logolblue-700 rounded-lg text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
