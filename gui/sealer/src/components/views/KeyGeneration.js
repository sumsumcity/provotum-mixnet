                            ...
                            <div class="w-full lg:w-1/2 mx-auto text-center">
                                ...
                                <div>
                                    <div className="flex justify-center items-center">
                                        ...
                                        <p className=" text-base lg:text-xl text-logobrown-1000 mx-2">1/1 {t("numberOfCreationsKeyGen")}</p>
                                    </div>
                                    <div className="flex justify-center items-center pt-4 pb-7 ">
                                        <FaCheck class="inline w-4 h-4 mr-3 text-green-700"/>
                                        <p className=" text-sm lg:text-base text-logobrown-1000 mx-2">{t("successfullKeyGen")}</p>
                                    </div>
                                    <div className="flex justify-center items-center pb-7">
                                        ...
                                        <p className=" text-sm lg:text-base text-logobrown-1000/50 mx-2">{t("waitingForVAKeyGen")}</p>
                                    </div>
                                </div>
                                ) 
                                : 
                                ...
                                <div>
                                    <div className="flex justify-center items-center pb-5">
                                        <FaKey className="text-logobrown-1000 mx-2"/>
                                        <p className="text-base lg:text-xl text-logobrown-1000 mx-2">0/1 {t("numberOfCreationsKeyGen")}</p>
                                    </div>
                                </div>
                                ):
                                (
                                <div>
                                    ...
                                    <div className="flex justify-center items-center pb-7">
                                        ...
                                        <p className=" text-sm lg:text-base text-logobrown-1000/50 mx-2">{t("waitingForVACreateAllQuestions")}</p>
                                    </div>
                                </div>
                                )}
                                ...
                                <div class="flex justify-center">
                                    {clickedCreateKey ? 
                                    (
                                    <button disabled type="button" class="w-1/2 sm:w-1/3 text-white bg-logodblue-300 py-2 lg:px-8 enabled:hover:bg-logodblue-500 rounded-lg text-sm lg:text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
                                    ...
                                    : 
                                    (
                                    <button onClick={() => createKey()} disabled={vote.sealers.indexOf(window._env_.SEALER) > -1 || !createdAllQuestions} class="w-1/2 sm:w-1/3 text-white bg-logodblue-300 py-2 lg:px-8 enabled:hover:bg-logodblue-500 rounded-lg text-sm lg:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("buttonKeyGen")}</button>
                                    )}
                                </div>
                            </div>
                        </div>
