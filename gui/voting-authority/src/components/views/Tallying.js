            ...
            <li key={index}>
                ...
                <div className="flex justify-between">
                    <div className="flex justify-start">
                        ...
                        <p>{apiQuestions[index].decrypted_sealers.length}/{maxNumberOfSealers} sealers decrypted the key</p>
                    </div>
                    <div>
                    {clickedCombineDecryptedKeys ? 
                        (
                        <button disabled type="button" class="w-full h-3/4 text-white bg-logored-500 pb-4 pt-1 px-3 enabled:hover:bg-logored-700 rounded-lg text-base transition-all disabled:opacity-75 disabled:cursor-not-allowed">
                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        <div class="float-right py-20 w-1/8">
                            {clickedNextStep ? 
                                ...
                                : 
                                (
                            <button onClick={() => nextStep()} disabled={nextStepPossible()} class="w-full text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Next Step</button>
                                )}
                        </div>
                    </div>
                </div>
