                ...
                <div class="flex w-full">
                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        <div class="float-right py-20 w-1/8">
                            <button disabled={true} class="w-full text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Next Step</button>
                        </div>
                    </div>
                </div>
