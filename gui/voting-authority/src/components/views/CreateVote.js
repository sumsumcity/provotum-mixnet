                    ...
                    {type===""? (
                        <div class="w-7/10 p-10 py-6">
                            ...
                            <div class="flex justify-around py-32">
                                <button onClick={() => setType("vote")} class="w-1/4 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Create Vote</button>
                                <button onClick={() => setType("election")} class="w-1/4 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Create Election</button>
                            </div>
                        </div>
                            ...
                            <div class="py-20 w-full">
                                {clickedNextStep ? (
                                    <div className="flex justify-between">
                                        <button onClick={() => setType("")} disabled={true} class="w-1/6 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Back</button>
                                ...
                                (
                                    <div className="flex justify-between">
                                        <button onClick={() => setType("")} disabled={vote!==""} class="w-1/6 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-0">Back</button>
