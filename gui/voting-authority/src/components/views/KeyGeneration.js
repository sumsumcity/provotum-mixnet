                        ...
                        <div class="container px-5 py-7 mx-auto">
                            <div class="w-1/2 mx-auto text-center">
                                <div className="flex justify-center items-center">
                                    ...
                                    <p className=" text-xl text-logobrown-1000 mx-2">{currentNumberOfSealers}/{maxNumberOfSealers} {t("numberOfKeysKeyGen")}</p>
                                </div>
                                ...
                                <div class="flex justify-center">
                                    ...
                                    : 
                                    (
                                    <button onClick={() => combineKeys()} disabled={maxNumberOfSealers!==currentNumberOfSealers || currentKeyShareStatus} class="w-1/3 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("combineKeysButtonKeyGen")}</button>
                                    )}
                                </div>
                            </div>
                        </div>
