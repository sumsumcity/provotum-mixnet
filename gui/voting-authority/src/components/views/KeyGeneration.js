                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-7/10 sm:p-10 py-6">
                        ...
                        <div class="container px-5 py-7 mx-auto">
                            <div class="w-full lg:w-1/2 mx-auto text-center">
                                ...
                                <div class="flex justify-center">
                                    {clickedCombineKeys ? 
                                    (
                                    <button disabled type="button" class="w-1/3 text-white bg-logored-500  py-2 xl:px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
                                    ...
                                    : 
                                    (
                                    <button onClick={() => combineKeys()} disabled={maxNumberOfSealers!==currentNumberOfSealers || currentKeyShareStatus} class="w-1/2 sm:w-1/3 text-white bg-logored-500 py-2 xl:px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("combineKeysButtonKeyGen")}</button>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="float-right py-5 lg:py-20 w-1/8">
                            ...
                            :
                            (
                                <button onClick={() => nextStep()} disabled={!currentKeyShareStatus} class="w-full text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("nextStepButton")}</button>
                            )}
                        </div>
                    </div>
                </div>
