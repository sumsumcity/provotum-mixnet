            ...
            <div class="container px-5 py-10 mx-auto flex">
                <div class="md:flex w-full">
                    ...
                    <div class="w-7/10 sm:p-10 py-6">
                        ...
                        <div class="container px-5 py-7 mx-auto">
                            <div class="w-full lg:w-1/2 mx-auto text-center">
                                <div className="flex justify-center items-center">
                                    ...
                                    <p className=" sm:text-xl text-logobrown-1000 mx-2">{currentNumberOfSealers}/{maxNumberOfSealers} {t("numberOfKeysKeyGen")}</p>
                                </div>
                                ...
                                <div className="flex justify-center items-center pt-4 pb-7 ">
                                    ...
                                    <p className=" text-base text-logobrown-1000 mx-2">{t("readyForCombineKeyGen")}</p>
                                </div>
                                ) 
                                : 
                                (
                                <div className="flex justify-center items-center pt-4 pb-4 sb:pb-7">
                                    ...
                                    <p className=" text-base text-logobrown-1000/50 mx-2">{t("waitingforSealersKeyGen")}</p>
                                </div>
                                )}
                                <span class="inline-block h-1 w-1/2 rounded bg-logobrown-300 mb-3 sb:mb-6"></span>
                                <div class="flex justify-center">
                                    {clickedCombineKeys ? 
                                    (
                                    <button disabled type="button" class="w-1/3 text-white bg-logored-500  py-2 xl:px-8 enabled:hover:bg-logored-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
                                    ...
                                    : 
                                    (
                                    <button onClick={() => combineKeys()} disabled={maxNumberOfSealers!==currentNumberOfSealers || currentKeyShareStatus} class="w-1/2 sm:w-1/3 text-white bg-logored-500 py-2 xl:px-8 enabled:hover:bg-logored-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("combineKeysButtonKeyGen")}</button>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="float-right pb-5 lg:py-20 w-1/8">
                            {clickedNextStep ? 
                            (
                            ...
                            :
                            (
                                <button onClick={() => nextStep()} disabled={!currentKeyShareStatus} class="w-full text-white bg-logored-500 py-2 px-2 md:px-8 enabled:hover:bg-logored-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("nextStepButton")}</button>
                            )}
                        </div>
                    </div>
                </div>
