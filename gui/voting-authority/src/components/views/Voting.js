                    ...
                    <div class="w-7/10 sm:p-10 py-6">
                        ...
                        <div class="float-right py-5 lg:py-20 w-1/8">
                            {clickedNextStep ? 
                                ...
                                type === "election" ?
                                (
                                <button onClick={() => setOpenModal(true)} class="w-full text-white bg-logored-500 py-2 px-2 md:px-8 enabled:hover:bg-logored-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("endElectionButton")}</button>
                                )
                                :
                                (
                                <button onClick={() => setOpenModal(true)} class="w-full text-white bg-logored-500 py-2 px-2 md:px-8 enabled:hover:bg-logored-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("endVoteButton")}</button>
                                )
                            }
                        </div>
                    </div>
