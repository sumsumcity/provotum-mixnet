                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        <div class="float-right py-20 w-1/8">
                            {clickedNextStep ? 
                                ...
                                : 
                                (
                            <button onClick={() => setOpenModal(true)} class="w-full text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Next Step</button>
                                )}
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center p-4 w-full h-full ">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to end the vote?</h3>
                            <p class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">After the end of the voting no one can submit their ballots.</p>
