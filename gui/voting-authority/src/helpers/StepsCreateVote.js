...
const StepsCreateVote = () => {
    ...
    return (
        ...
        <div class="block w-1/5 sm:flex relative sm:pb-12">
            <div className="flex justify-center">
                <div class="h-8 sm:h-full w-full sm:w-10 absolute inset-0 flex items-center justify-end sm:justify-center">
                    <div class="float-right h-1 sm:h-full w-1/2 sm:w-1 bg-logobrown-300"></div>
                </div>
        ...
        <div class="block w-1/5 sm:flex relative sm:pb-12">
            <div className="flex justify-center">
                <div class="h-8 sm:h-full w-full sm:w-10 absolute inset-0 flex items-center justify-end sm:justify-center">
                    <div class="h-1 sm:h-full w-full sm:w-1 bg-logobrown-300"></div>
                </div>
                <div class="flex-shrink-0 w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-white inline-flex items-center justify-center text-logobrown-300 relative z-10 border-2 border-logobrown-300">
                    <RiNumber2 size={20}/>
                </div>
            </div>
            <div class="hidden sm:flex pl-4 items-center">
                <h3 class="font-medium text-lg text-logobrown-300 tracking-wider">{t("keygenStep")}</h3>
            </div>
        </div>
