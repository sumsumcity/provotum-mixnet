                        ...
                        <div class="flex justify-center w-full">
                            <div class="w-1/2 bg-logored-100 rounded-lg p-8 flex flex-col">
                                ...
                                <div class="flex justify-center py-5">
                                    ...
                                    (<button onClick={() => login()} class="w-1/3 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("buttonLogin")}</button>
                                    )}
                                </div>
                            </div>
