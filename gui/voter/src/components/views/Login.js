                        ...
                        <div class="flex justify-center w-full">
                            <div class="w-full lg:w-1/2 bg-logolblue-100 rounded-lg p-8 flex flex-col">
                                ...
                                <div class="flex justify-center py-5">
                                    {clickedLogin ? (
                                        <button disabled type="button" class="w-1/2 sm:w-1/3 text-white bg-logolblue-500 py-2 px-2 md:px-8 enabled:hover:bg-logolblue-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
                                    ...
                                    (<button onClick={() => login()} class="w-1/2 sm:w-1/3 text-white bg-logolblue-500 py-2 px-2 md:px-8 enabled:hover:bg-logolblue-700 rounded-lg text-sm md:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("buttonLogin")}</button>
                                    )}
                                </div>
                            </div>
