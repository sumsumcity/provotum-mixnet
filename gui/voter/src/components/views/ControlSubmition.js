            ...
            <div class="container px-5 py-10 mx-auto flex">
                <div class="flex w-full">
                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        : 
                        (
                            <button onClick={() => submitElection()} class="w-1/6 mt-20 float-right text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("submitButton")}</button>
                        )}
                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        : 
                        (
                            <button onClick={() => submit()} class="w-1/6 mt-20 float-right text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("submitButton")}</button>
                        )}
