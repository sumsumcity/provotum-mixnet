                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-7/10 sm:p-10 py-6">
                        ...
                        <div className="flex justify-between pb-10 w-full">
                            ...
                            {clickedSubmit ? 
                            (
                                <button disabled type="button" class="w-1/3 xl:w-1/6 mt-2 md:mt-20 float-left text-white bg-logolblue-500 py-2 lg:px-8 enabled:hover:bg-logolblue-700 rounded-lg text-md lg:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                            ...
                            : 
                            (
                                <button onClick={() => setOpenModalElection(true)} class="w-1/3 xl:w-1/6 mt-2 md:mt-20 float-right text-white bg-logolblue-500 py-2 lg:px-8 enabled:hover:bg-logolblue-700 rounded-lg text-md lg:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("submitButton")}</button>
                            )}
                        </div>
                    ...
                    <div class="w-7/10 sm:p-10 py-6">
                        ...
                        <div className="flex justify-between pb-10 w-full">
                            ...
                            : 
                            (
                                <button onClick={() => setOpenModal(true)} class="w-1/3 xl:w-1/6 mt-2 md:mt-20 float-right text-white bg-logolblue-500 py-2 lg:px-8 enabled:hover:bg-logolblue-700 rounded-lg text-md lg:text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">{t("submitButton")}</button>
                            )}
                        </div>
                    </div>
                    )}   
