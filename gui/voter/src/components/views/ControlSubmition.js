            ...
            <div class="container px-5 py-10 mx-auto flex">
                <div class="flex w-full">
                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        {clickedSubmit ? 
                        (
                            <button disabled type="button" class="w-1/6 float-right mt-20 text-white bg-logolblue-500 py-2 px-8 enabled:hover:bg-logolblue-700 rounded-lg text-lg transition-all disabled:opacity-75 disabled:cursor-not-allowed">
