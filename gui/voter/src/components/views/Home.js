                    ...
                    <div class="w-7/10 p-10 py-6">
                        ...
                        (
                            <div class="flex justify-center w-full">
                                <div class="w-3/4 bg-logored-100 rounded-lg p-8 mt-20 flex flex-col">
                                    <div className="">
                                        ...
                                        <div className="flex justify-between px-20">
                                            ...
                                            <div className="flex justify-center basis-1/3 ">
                                                <button onClick={() => fillOutBallot()} disabled={vote.phase!=="Voting"} class="w-3/4 text-white bg-logored-500 py-2 px-8 enabled:hover:bg-logored-700 rounded-lg text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed">Fill out ballot</button>
                                            </div>
                                                <div className="flex justify-center basis-1/3">
                                                {vote.phase==="Voting" ? 
                                                (
                            ...
                            <div class="flex justify-center ">
                                <div class="w-2/3 flex flex-col">
                                    <div class="pt-20 text-center">
                                        <svg role="status" class="inline w-20 h-20 text-logored-100 animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
