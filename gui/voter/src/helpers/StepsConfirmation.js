    ...
    return (
        ...
        <div class="block w-1/3 md:flex relative md:pb-12">
            <div className="flex justify-center">
                ...
                <div class="flex-shrink-0 w-8 md:w-10 h-8 md:h-10 rounded-full bg-white inline-flex items-center justify-center text-logolblue-500 relative z-10 border-2 border-logolblue-500">
                    <FaCheck size={20}/>
                </div>
            </div>
        ...
        <div class="block w-1/3 md:flex relative md:pb-12">
            <div className="flex justify-center">
                <div class="h-8 md:h-full w-full md:w-10 absolute inset-0 flex items-center justify-end md:justify-center">
                    ...
                    <div class="h-1 md:h-full w-full md:w-1 bg-logolblue-500"></div>
                </div>
                <div class="flex-shrink-0 w-8 md:w-10 h-8 md:h-10 rounded-full bg-white inline-flex items-center justify-center text-logolblue-500 relative z-10 border-2 border-logolblue-500">
                    <FaCheck size={20}/>
                </div>
            ...
            <div class="hidden md:flex pl-4 items-center">
                <h3 class="font-medium text-lg text-logobrown-1000 tracking-wider">{t("secondStep")}</h3>
            </div>
        </div>
        ...
        <div class="block w-1/3 md:flex relative md:pb-12">
            ...
            <div class="hidden md:flex pl-4 items-center">
                <h3 class="font-medium text-lg text-logobrown-1000 tracking-wider">{t("thirdStep")}</h3>
            </div>
        </div>
