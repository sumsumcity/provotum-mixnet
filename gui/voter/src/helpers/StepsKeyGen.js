    ...
    return (
        <div class="w-3/10 pr-10 py-6 border-r-2 border-logored-100">
            ...
            <div class="flex relative pb-12">
                ...
                <div class="flex pl-4 items-center">
                    <h3 class="font-medium title-font text-lg text-logored-100 tracking-wider">VOTING</h3>
                </div>
            </div>
            ...
            <div class="flex relative pb-12">
                ...
                <div class="flex pl-4 items-center">
                    <h3 class="font-medium title-font text-lg text-logored-100 tracking-wider">TALLYING</h3>
                </div>
            </div>
            ...
            <div class="flex relative">
                ...
                <div class="flex pl-4 items-center">
                    <h3 class="font-medium title-font text-lg text-logored-100 tracking-wider">RESULT</h3>
                </div>
            </div>
